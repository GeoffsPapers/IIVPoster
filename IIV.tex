...
{\em Type-promotion} functions are used to convert domain elements to terms.
...
The type declarations have been omited, but can be seen in URL provided.
